...
This rmd file includes creating, documenting, and testing a custom R function called `scale_and_multiply`. The function takes a numeric vector, scales it between 0 and 1, and then multiplies it by a specified value. The assignment is separated into 4 exerices. 
